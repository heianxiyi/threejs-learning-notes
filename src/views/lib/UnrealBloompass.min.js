...
Object.assign(Pass.prototype, {
  ...
  (Pass.FullScreenQuad = (function () {
    var camera = new OrthographicCamera(-1, 1, 1, -1, 0, 1),
      ...
      FullScreenQuad = function (material) {
...
var UnrealBloomPass = function (resolution, strength, radius, threshold) {
  ...
  void 0 === LuminosityHighPassShader &&
...
(UnrealBloomPass.prototype = Object.assign(Object.create(Pass.prototype), {
  ...
  render: function (renderer, writeBuffer, readBuffer, deltaTime, maskActive) {
    this.oldClearColor.copy(renderer.getClearColor(new Color(0))),
      (this.oldClearAlpha = renderer.getClearAlpha());
    var oldAutoClear = renderer.autoClear;
    (renderer.autoClear = !1),
      renderer.setClearColor(this.clearColor, 0),
      maskActive && renderer.state.buffers.stencil.setTest(!1),
      this.renderToScreen &&
      ...
      this.fsQuad.render(renderer);
    for (
      var inputRenderTarget = this.renderTargetBright, i = 0;
      i < this.nMips;
      i++
    )
    ...
    (this.fsQuad.material = this.compositeMaterial),
      ...
      maskActive && renderer.state.buffers.stencil.setTest(!0),
      this.renderToScreen
        ? (renderer.setRenderTarget(null), this.fsQuad.render(renderer))
        : (renderer.setRenderTarget(readBuffer), this.fsQuad.render(renderer)),
